...
{
	/// <summary>
    /// Defines the contract for the CustomerAccessControlEntry class
    /// </summary>
    [ComVisible(true)]
    [Guid("45ec7112-5a92-a97d-2e87-60ad617c079d")]
	[InterfaceType(ComInterfaceType.InterfaceIsDual)]
	public interface ICustomerAccessControlEntry
	{
		bool Exists { get; }
		...
		Services.Packages.Security.CustomerAccessControlList ACL { get; set; }
        ...
        void Update();
        void Delete();
		void CopyWithKeysFrom(CustomerAccessControlEntry _object);
		void CopyWithKeysTo(CustomerAccessControlEntry _object);
		void CopyFrom(CustomerAccessControlEntry _object);
		void CopyTo(CustomerAccessControlEntry _object);

	}
	
	/// <summary>
    /// Defines the contract for all the service-based types which can
    /// apply servicing on Services.Packages.Security.CustomerAccessControlEntry type.
    /// </summary>
    [ComVisible(true)]
    [Guid("fd5e796b-78f7-2b83-aaa7-1817ab6191e6")]
    [InterfaceType(ComInterfaceType.InterfaceIsDual)]
    [ServiceContract(Namespace="http://services.msd.com")]
    public interface ICustomerAccessControlEntryService
    {
		string Uri { get; set; }

		[OperationContract]
        bool Exists(CustomerAccessControlEntry _CustomerAccessControlEntry);
		[OperationContract]
        CustomerAccessControlEntry Read(System.String __Descriptor, System.String __UserName, System.String __Name);
        [OperationContract]
        CustomerAccessControlEntry Reload(CustomerAccessControlEntry _CustomerAccessControlEntry);
        [OperationContract]
        CustomerAccessControlEntry Create(System.String __Descriptor, System.String __UserName, System.String __Name);
        [OperationContract]
        void Delete(System.String __Descriptor, System.String __UserName, System.String __Name);
        [OperationContract]
        void UpdateObject(CustomerAccessControlEntry _CustomerAccessControlEntry);
        [OperationContract]
        void CreateObject(CustomerAccessControlEntry _CustomerAccessControlEntry);
        [OperationContract]
        void DeleteObject(CustomerAccessControlEntry _CustomerAccessControlEntry);
        [OperationContract]
        void Undo();
        [OperationContract]
        void Redo();
		[OperationContract]
		CustomerAccessControlEntryCollection GetByACL(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList);
		[OperationContract]
		CustomerAccessControlEntryCollection GetByACLPaged(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount);
		[OperationContract]
		long GetByACLCount(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList);
		[OperationContract]
		Services.Packages.Security.CustomerAccessControlList GetACL(CustomerAccessControlEntry _CustomerAccessControlEntry);
		[OperationContract]
		void SetACL(CustomerAccessControlEntry _CustomerAccessControlEntry, Services.Packages.Security.CustomerAccessControlList _ACL);
		[OperationContract]
		CustomerAccessControlEntryCollection GetEntries(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList);
		[OperationContract]
		CustomerAccessControlEntryCollection GetEntriesPaged(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount);
		[OperationContract]
		long GetEntriesCount(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList);

    }
    
    /// <summary>
    /// WCF and default implementation of a service object for Services.Packages.Security.CustomerAccessControlEntry type.
    /// </summary>
    [ComVisible(true)]
	[ClassInterface(ClassInterfaceType.None)]
    [Guid("6a9c6a43-8852-0a6e-241a-cedaf42a62b9")]
    ...
    sealed public class CustomerAccessControlEntryService : ICustomerAccessControlEntryService
    {
		/// <summary>
		...
		[WebMethod]
        public bool Exists(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			return _CustomerAccessControlEntry.Exists;
        }
		
		[WebMethod]
		public CustomerAccessControlEntry Read(System.String __Descriptor, System.String __UserName, System.String __Name)
		{
			return new CustomerAccessControlEntry(__Descriptor, __UserName, __Name);
		}
		
		[WebMethod]
        public CustomerAccessControlEntry Reload(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			_CustomerAccessControlEntry.Reload();
			return _CustomerAccessControlEntry;
        }
		
		[WebMethod]
        public CustomerAccessControlEntry Create(System.String __Descriptor, System.String __UserName, System.String __Name)
        {
			return CustomerAccessControlEntry.CreateCustomerAccessControlEntry(__Descriptor, __UserName, __Name);
        }
        
        [WebMethod]
        public void Delete(System.String __Descriptor, System.String __UserName, System.String __Name)
        {
			CustomerAccessControlEntry.DeleteCustomerAccessControlEntry(__Descriptor, __UserName, __Name);
        }
        
        [WebMethod]
        public void UpdateObject(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			_CustomerAccessControlEntry.Update();
        }
		
		[WebMethod]
        public void CreateObject(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			_CustomerAccessControlEntry.Create();
        }
        
        [WebMethod]
        public void DeleteObject(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			_CustomerAccessControlEntry.Delete();
        }
		
		[WebMethod]
        public void Undo()
        {
			CustomerAccessControlEntry.Undo();
        }
        
        [WebMethod]
        public void Redo()
        {
			CustomerAccessControlEntry.Redo();
        }
		[WebMethod]
		public CustomerAccessControlEntryCollection GetByACL(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
		{
			return CustomerAccessControlEntry.GetByACL( _CustomerAccessControlList);
		}
		[WebMethod]
		public CustomerAccessControlEntryCollection GetByACLPaged(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount)
		{
			return CustomerAccessControlEntry.GetByACLPaged( _CustomerAccessControlList, PagingStart, PagingCount);
		}
		[WebMethod]
		public long GetByACLCount(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
		{
			return CustomerAccessControlEntry.GetByACLCount( _CustomerAccessControlList);
		}
		[WebMethod]
		public Services.Packages.Security.CustomerAccessControlList GetACL(CustomerAccessControlEntry _CustomerAccessControlEntry)
		{
			_CustomerAccessControlEntry.Reload();
			return _CustomerAccessControlEntry.ACL;
		}
		[WebMethod]
		public void SetACL(CustomerAccessControlEntry _CustomerAccessControlEntry, Services.Packages.Security.CustomerAccessControlList _ACL)
		{
			_CustomerAccessControlEntry.Reload();
			_CustomerAccessControlEntry.ACL = _ACL;
			_CustomerAccessControlEntry.Update();
		}
		[WebMethod]
		public CustomerAccessControlEntryCollection GetEntries(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
		{
			return CustomerAccessControlEntry.GetEntries(Descriptor,  _CustomerAccessControlList);
		}
		[WebMethod]
		public CustomerAccessControlEntryCollection GetEntriesPaged(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount)
		{
			return CustomerAccessControlEntry.GetEntriesPaged(Descriptor,  _CustomerAccessControlList, PagingStart, PagingCount);
		}
		[WebMethod]
		public long GetEntriesCount(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
		{
			return CustomerAccessControlEntry.GetEntriesCount(Descriptor,  _CustomerAccessControlList);
		}

    }
	
	/// <summary>
    /// Provides the implementation of Services.Packages.Security.CustomerAccessControlEntry model that acts as DAL for
    /// a database table.
    /// </summary>
    [ComVisible(true)]
	[ClassInterface(ClassInterfaceType.None)]
    [Guid("b7a1ada7-feb6-9a7d-edc0-9bea4265fecd")]
    [DataContract]
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
    [Serializable]
    public class CustomerAccessControlEntry : ICustomerAccessControlEntry, IHierarchyData, global::Platform.Runtime.Data.IModelHierachyData
    {
		#region Servicing support

		// Synchronized replication
        [NonSerialized]
        static List<ICustomerAccessControlEntryService> replicationServices = null;
        
        // Scaling proxy objects (using 1 object you get forwarding)
        [NonSerialized]
        static List<ICustomerAccessControlEntryService> scalingServices = null;
		// static IServiceSelectionAlgorithm serviceSelectionAlgorithm = null;

        // Failover scenario
        [NonSerialized]
        static List<ICustomerAccessControlEntryService> failoverServices = null;
		...
		public static string ClassConnectionString
        {
            get
            {
				...
				if (global::System.Configuration.ConfigurationManager.ConnectionStrings["Services.Packages.Security.CustomerAccessControlEntry"] != null)
					classConnectionString = global::System.Configuration.ConfigurationManager.ConnectionStrings["Services.Packages.Security.CustomerAccessControlEntry"].ConnectionString;
		...
		public static global::Platform.Runtime.SqlProviderType ClassSqlProviderType
        {
            get
            {
				...
				classSqlProviderType = global::Platform.Runtime.Sql.GetProviderConfiguration("Services.Packages.Security.CustomerAccessControlEntry.ProviderType");
		...
		Services.Packages.Security.CustomerAccessControlList _ACL;
		
		
		[System.Xml.Serialization.XmlIgnoreAttribute]
		public Services.Packages.Security.CustomerAccessControlList ACL
		{
            get
            {
				if (!_ACLIsLoaded)
				{
					_ACL = new Services.Packages.Security.CustomerAccessControlList(_UserName, _Name);
					if (_ACL.Exists)
						_ACLIsLoaded = true;
					else _ACL = null;
				}
		...
		public static Services.Packages.Security.CustomerAccessControlList GetACL(CustomerAccessControlEntry _CustomerAccessControlEntry)
		{
			return _CustomerAccessControlEntry.ACL;
		}

		public static CustomerAccessControlEntryCollection GetByACL(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
        {
			CustomerAccessControlEntryCollection _CustomerAccessControlEntryCollection = new CustomerAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("CuAcCoEnGetByACL", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
                
                DbParameter param_UserName;
				if (_CustomerAccessControlList != null) {
				param_UserName = ClassConnectionProvider.GetDatabaseParameter("UserName", typeof(System.String), 128);
				param_UserName.Value = ClassConnectionProvider.FromValueToSqlModelType(_CustomerAccessControlList.UserName);
				} else {
				...
				param_Name.Value = ClassConnectionProvider.FromValueToSqlModelType(_CustomerAccessControlList.Name);
				} else {
                ...
                while (dr.Read())
                {
					CustomerAccessControlEntry o = new CustomerAccessControlEntry();
				...
				if (dr["Name"] == DBNull.Value) { o._ACL = null; o._ACLIsLoaded = true; }  else o._Name = (System.String) global::Platform.Runtime.Utilities.FromSqlToValue(dr["Name"], typeof(System.String));
                    ...
                    _CustomerAccessControlEntryCollection.Add(o);
                }

                dr.Close();
            }
            
            return _CustomerAccessControlEntryCollection;
        }
        
        public static CustomerAccessControlEntryCollection GetByACLPaged(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount)
        {
			CustomerAccessControlEntryCollection _CustomerAccessControlEntryCollection = new CustomerAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("CuAcCoEnGetByACLPaged", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public static long GetByACLCount(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
        {
			long count = 0;
            ...
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("CuAcCoEnGetByACLCount", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
		...
		public static CustomerAccessControlEntryCollection GetEntries(System.String _Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
        {
			CustomerAccessControlEntryCollection _CustomerAccessControlEntryCollection = new CustomerAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("CuAcCoEnGeEn", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
				...
				DbParameter param_CustomerAccessControlList_UserName;
				if (_CustomerAccessControlList != null) {
				param_CustomerAccessControlList_UserName = ClassConnectionProvider.GetDatabaseParameter("CuAcCoLiUsNa", typeof(System.String), 128);
				param_CustomerAccessControlList_UserName.Value = ClassConnectionProvider.FromValueToSqlModelType(_CustomerAccessControlList.UserName);
				} else {
				param_CustomerAccessControlList_UserName = ClassConnectionProvider.GetDatabaseParameter("CuAcCoLiUsNa", DBNull.Value);
				}
				command.Parameters.Add(param_CustomerAccessControlList_UserName);
				DbParameter param_CustomerAccessControlList_Name;
				if (_CustomerAccessControlList != null) {
				param_CustomerAccessControlList_Name = ClassConnectionProvider.GetDatabaseParameter("CuAcCoLiNa", typeof(System.String), 256);
				param_CustomerAccessControlList_Name.Value = ClassConnectionProvider.FromValueToSqlModelType(_CustomerAccessControlList.Name);
				} else {
				param_CustomerAccessControlList_Name = ClassConnectionProvider.GetDatabaseParameter("CuAcCoLiNa", DBNull.Value);
				}
				command.Parameters.Add(param_CustomerAccessControlList_Name);
        ...
        public static CustomerAccessControlEntryCollection GetEntriesPaged(System.String _Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount)
        {
			CustomerAccessControlEntryCollection _CustomerAccessControlEntryCollection = new CustomerAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("CuAcCoEnGeEnPaged", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public static long GetEntriesCount(System.String _Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList)
        {
			long count = 0;
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("CuAcCoEnGeEnCount", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public CustomerAccessControlEntry() {}
        
        public CustomerAccessControlEntry(System.String __Descriptor, System.String __UserName, System.String __Name)
        {
        ...
        void Exist()
        {
			...
			{
				dbconn.Open();
				DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("CuAcCoEnRead", dbconn);
				command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public void Read(System.String __Descriptor, System.String __UserName, System.String __Name)
        {
			if (scalingServices != null)
            {
                ...
                // int nextIndex = serviceSelectionAlgorithm.Pick(scalingServices, "CuAcCoEn");
        ...
        public void Reload()
        {
			if (scalingServices != null)
            {
                ...
                // Get a service via an algorithm
                // int nextIndex = serviceSelectionAlgorithm.GetNext(scalingServices, "CuAcCoEn");
                // Perfect for read operations, but not for write
        ...
        public void Create()
        {
            ...
            {		
				if (!Exists)
				{
					...
					{
						dbconn.Open();
						DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("CuAcCoEnCreate", dbconn);
						command.CommandType = global::System.Data.CommandType.StoredProcedure;
				...
				DbParameter param_ACL_Name = ClassConnectionProvider.GetDatabaseParameter("Name", typeof(System.String), 256);
        ...
        static public CustomerAccessControlEntry CreateCustomerAccessControlEntry(System.String __Descriptor, System.String __UserName, System.String __Name)
        {
            CustomerAccessControlEntry o = new CustomerAccessControlEntry(__Descriptor, __UserName, __Name);
        ...
        public void Update()
        {
            ...
            {			
				...
				{
					dbconn.Open();
					DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("CuAcCoEnUpdate", dbconn);
					command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public void Delete()
        {
            ...
            {			
				...
				{
					dbconn.Open();
					DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("CuAcCoEnDelete", dbconn);
					command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        static public void DeleteCustomerAccessControlEntry(System.String __Descriptor, System.String __UserName, System.String __Name)
        {
            CustomerAccessControlEntry o = new CustomerAccessControlEntry(__Descriptor, __UserName, __Name);
        ...
        public void CopyWithKeysFrom(CustomerAccessControlEntry _object)
        {
			_ACL = null;
			_ACLIsLoaded = false;
        ...
        public void CopyWithKeysTo(CustomerAccessControlEntry _object)
        {
			_object._ACL = null;
        ...
        static public void CopyWithKeysObject(CustomerAccessControlEntry _objectFrom, CustomerAccessControlEntry _objectTo)
        {
			_objectFrom.CopyWithKeysTo(_objectTo);
        }
        
        public void CopyFrom(CustomerAccessControlEntry _object)
        {
			_ACL = null;
			_ACLIsLoaded = false;
			_Allow = _object._Allow;
        ...
        public void CopyTo(CustomerAccessControlEntry _object)
        {
			_object._ACL = null;
			_object._ACLIsLoaded = false;
			_object._Allow = _Allow;
        ...
        static public void CopyObject(CustomerAccessControlEntry _objectFrom, CustomerAccessControlEntry _objectTo)
        {
		...
		public static bool IsUndoRedoSupported
		{
			get {
				if (!isUndoRedoSupportedHasBeenLoaded) {
                    ...
                    Platform.Module.UndoRedo.Services.Packages.UndoRedoOptions options = new Platform.Module.UndoRedo.Services.Packages.UndoRedoOptions(typeof(CustomerAccessControlEntry).FullName);
                    if (!options.Exists)
                    {
		...
		static void MarkUndo(CustomerAccessControlEntry _object, bool IsCreatedUndoDeletes, bool IsDeletedUndoCreates, bool IsUpdatedUndoUpdates)
        {
			// Delete already undone entries (steps that have been undone but not redone)
			CustomerAccessControlEntryUndoRedoCollection allUndidAndNotRedoneEntries = CustomerAccessControlEntryUndoRedo.GetAllFilterByIsUndone(true);
			for(int n = 0; n < allUndidAndNotRedoneEntries.Count; ++n)
				allUndidAndNotRedoneEntries[n].Delete();

			// Create one undo entry
			CustomerAccessControlEntryUndoRedo _urobject = new CustomerAccessControlEntryUndoRedo();
			...
			Platform.Module.UndoRedo.Services.Packages.Grouping.GroupEntry(typeof(CustomerAccessControlEntry).FullName, _urobject.UndoRedoId);

			// Check if we have too many - if yes delete the oldest entry
			long count = CustomerAccessControlEntryUndoRedo.GetAllWithNoFilterCount(true) - undoRedoMaximumObjects;
			if (count > 0)
			{
				CustomerAccessControlEntryUndoRedoCollection allOldUndoEntries = CustomerAccessControlEntryUndoRedo.GetAllWithNoFilterOppositeSortingPaged(true, 0, count);
		...
		static public void Undo()
        {
			...
			CustomerAccessControlEntryUndoRedoCollection firstUndoEntries = CustomerAccessControlEntryUndoRedo.GetAllFilterByIsUndonePaged(false, 0, 1);
			if (firstUndoEntries.Count < 1)
				return;

			CustomerAccessControlEntryUndoRedo _urobject = firstUndoEntries[0];
			
			CustomerAccessControlEntry _object = new CustomerAccessControlEntry();
			_object._ACL = null;
			_object._ACLIsLoaded = false;
        ...
        static public void Redo()
        {
			...
			CustomerAccessControlEntryUndoRedoCollection firstEntryToRedoEntries = CustomerAccessControlEntryUndoRedo.GetAllFilterByIsUndoneOppositeOrderPaged(true, 0, 1);
			if (firstEntryToRedoEntries.Count < 1)
				return;

			CustomerAccessControlEntryUndoRedo _urobject = firstEntryToRedoEntries[0];
    ...
    /// <summary>
    /// Defines the contract for the CustomerAccessControlEntryCollection class
    /// </summary>
    [ComVisible(true)]
	[InterfaceType(ComInterfaceType.InterfaceIsDual)]
    [Guid("f66a7af5-9ce0-e34b-0a53-d8dca9a8377f")]
    public interface ICustomerAccessControlEntryCollection : IEnumerable<CustomerAccessControlEntry>
    {
        int IndexOf(CustomerAccessControlEntry item);
        void Insert(int index, CustomerAccessControlEntry item);
        void RemoveAt(int index);
        CustomerAccessControlEntry this[int index] { get; set; }
        void Add(CustomerAccessControlEntry item);
        void Clear();
        bool Contains(CustomerAccessControlEntry item);
        void CopyTo(CustomerAccessControlEntry[] array, int arrayIndex);
        int Count { get; }
        bool IsReadOnly { get; }
        bool Remove(CustomerAccessControlEntry item);
    }

    /// <summary>
    /// Provides the implementation of the class that represents a list of Services.Packages.Security.CustomerAccessControlEntry
    /// </summary>
    [ClassInterface(ClassInterfaceType.None)]
    [Guid("fd705e45-dac0-452f-ec01-7c91ec84c8bf")]
    [DataContract]
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
    [Serializable]
    public class CustomerAccessControlEntryCollection : ICustomerAccessControlEntryCollection, IList<CustomerAccessControlEntry>, IHierarchicalEnumerable
    {
        List<CustomerAccessControlEntry> _list = new List<CustomerAccessControlEntry>();
        
        public static implicit operator List<CustomerAccessControlEntry>(CustomerAccessControlEntryCollection collection)
        {
            return collection._list;
        }

        #region IList<CustomerAccessControlEntry> Members

        public int IndexOf(CustomerAccessControlEntry item)
        {
            return _list.IndexOf(item);
        }

        public void Insert(int index, CustomerAccessControlEntry item)
        {
        ...
        public CustomerAccessControlEntry this[int index]
        {
            get
            {
                return _list[index];
        ...
        #region ICollection<CustomerAccessControlEntry> Members

        public void Add(CustomerAccessControlEntry item)
        {
            _list.Add(item);
        }
        ...
        public bool Contains(CustomerAccessControlEntry item)
        {
            return _list.Contains(item);
        }

        public void CopyTo(CustomerAccessControlEntry[] array, int arrayIndex)
        {
        ...
        public bool Remove(CustomerAccessControlEntry item)
        {
        ...
        #region IEnumerable<CustomerAccessControlEntry> Members

        public IEnumerator<CustomerAccessControlEntry> GetEnumerator()
        {
...
namespace Web
{
	...
	/// that share Services.Packages.Security.CustomerAccessControlEntry objects.
	/// </summary>
    /// <example>
    /// You can use that in the header of an asmx file like this:
    /// <%@ WebService Language="C#" Class="Services.Packages.Security.Web.CustomerAccessControlEntryWebService" %>
    /// </example>
	...
	[global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
	[ComVisible(false)]
    sealed public class CustomerAccessControlEntryWebService : WebService, ICustomerAccessControlEntryService
	{
		/// <summary>
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="CustomerAccessControlEntryWebServiceSoap", Namespace="http://services.msd.com")]
	[System.Xml.Serialization.XmlIncludeAttribute(typeof(MarshalByRefObject))]
	[ComVisible(true)]
	[ClassInterface(ClassInterfaceType.None)]
    [Guid("79e5011c-6cbf-0ad9-62bd-ac6225a0f144")]
    sealed public class CustomerAccessControlEntryWebServiceClient : System.Web.Services.Protocols.SoapHttpClientProtocol, ICustomerAccessControlEntryService
	{
		...
		public CustomerAccessControlEntryWebServiceClient(string url)
		{
			this.Url = url;
		}
        ...
        /// </summary>
		public CustomerAccessControlEntryWebServiceClient()
		{
		...
		public bool Exists(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			object[] results = this.Invoke("Exists", new object[] {_CustomerAccessControlEntry});
		...
		public CustomerAccessControlEntry Read(System.String __Descriptor, System.String __UserName, System.String __Name)
		{
			...
			return ((CustomerAccessControlEntry)(results[0]));
		}
		...
		public CustomerAccessControlEntry Reload(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			object[] results = this.Invoke("Reload", new object[] {_CustomerAccessControlEntry});
			return ((CustomerAccessControlEntry)(results[0]));
        }
        ...
        public void UpdateObject(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			this.Invoke("UpdateObject", new object[] {_CustomerAccessControlEntry});
			return;
        }
		...
		public void CreateObject(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			this.Invoke("CreateObject", new object[] {_CustomerAccessControlEntry});
			return;
        }
        ...
        public void DeleteObject(CustomerAccessControlEntry _CustomerAccessControlEntry)
        {
			this.Invoke("DeleteObject", new object[] {_CustomerAccessControlEntry});
			return;
        }
		...
		public CustomerAccessControlEntryCollection GetByACL(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList) {
			object[] results = this.Invoke("GetByACL", new object[] {_CustomerAccessControlList});
			return ((CustomerAccessControlEntryCollection)(results[0]));
		}
		...
		public CustomerAccessControlEntryCollection GetByACLPaged(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount) {
			object[] results = this.Invoke("GetByACLPaged", new object[] {_CustomerAccessControlList,PagingStart,PagingCount});
			return ((CustomerAccessControlEntryCollection)(results[0]));
		}
		...
		public long GetByACLCount(Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList) {
			object[] results = this.Invoke("GetByACLCount", new object[] {_CustomerAccessControlList});
		...
		public Services.Packages.Security.CustomerAccessControlList GetACL(CustomerAccessControlEntry _CustomerAccessControlEntry)
		{
			object[] results = this.Invoke("GetACL", new object[] {_CustomerAccessControlEntry});
			return ((Services.Packages.Security.CustomerAccessControlList)(results[0]));
		}
		...
		public void SetACL(CustomerAccessControlEntry _CustomerAccessControlEntry, Services.Packages.Security.CustomerAccessControlList _ACL)
		{
			this.Invoke("GetACL", new object[] {_CustomerAccessControlEntry});
			return;
		}
		...
		public CustomerAccessControlEntryCollection GetEntries(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList) {
			object[] results = this.Invoke("GetEntries", new object[] {Descriptor, _CustomerAccessControlList});
			return ((CustomerAccessControlEntryCollection)(results[0]));
		}
		...
		public CustomerAccessControlEntryCollection GetEntriesPaged(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList, long PagingStart, long PagingCount) {
			object[] results = this.Invoke("GetEntriesPaged", new object[] {Descriptor, _CustomerAccessControlList,PagingStart,PagingCount});
			return ((CustomerAccessControlEntryCollection)(results[0]));
		}
		...
		public long GetEntriesCount(System.String Descriptor, Services.Packages.Security.CustomerAccessControlList _CustomerAccessControlList) {
			object[] results = this.Invoke("GetEntriesCount", new object[] {Descriptor, _CustomerAccessControlList});
			return ((long)(results[0]));
		}
