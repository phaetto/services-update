...
{
	/// <summary>
    /// Defines the contract for the ApplicationExceptionAccessControlEntry class
    /// </summary>
    [ComVisible(true)]
    [Guid("7c6bcdca-2bb1-89c1-13a5-31d01213e7b4")]
	[InterfaceType(ComInterfaceType.InterfaceIsDual)]
	public interface IApplicationExceptionAccessControlEntry
	{
		bool Exists { get; }
		...
		Services.Packages.Log.Security.ApplicationExceptionAccessControlList ACL { get; set; }
        ...
        void Update();
        void Delete();
		void CopyWithKeysFrom(ApplicationExceptionAccessControlEntry _object);
		void CopyWithKeysTo(ApplicationExceptionAccessControlEntry _object);
		void CopyFrom(ApplicationExceptionAccessControlEntry _object);
		void CopyTo(ApplicationExceptionAccessControlEntry _object);

	}
	
	/// <summary>
    /// Defines the contract for all the service-based types which can
    /// apply servicing on Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry type.
    /// </summary>
    [ComVisible(true)]
    [Guid("3a48535f-5089-c225-4614-95be338a14e2")]
    [InterfaceType(ComInterfaceType.InterfaceIsDual)]
    [ServiceContract(Namespace="http://services.msd.com")]
    public interface IApplicationExceptionAccessControlEntryService
    {
		string Uri { get; set; }

		[OperationContract]
        bool Exists(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry);
		[OperationContract]
        ApplicationExceptionAccessControlEntry Read(System.String __Descriptor, System.String __UserName, System.Int32 __Id);
        [OperationContract]
        ApplicationExceptionAccessControlEntry Reload(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry);
        [OperationContract]
        ApplicationExceptionAccessControlEntry Create(System.String __Descriptor, System.String __UserName, System.Int32 __Id);
        [OperationContract]
        void Delete(System.String __Descriptor, System.String __UserName, System.Int32 __Id);
        [OperationContract]
        void UpdateObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry);
        [OperationContract]
        void CreateObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry);
        [OperationContract]
        void DeleteObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry);
        [OperationContract]
        void Undo();
        [OperationContract]
        void Redo();
		[OperationContract]
		ApplicationExceptionAccessControlEntryCollection GetByACL(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList);
		[OperationContract]
		ApplicationExceptionAccessControlEntryCollection GetByACLPaged(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount);
		[OperationContract]
		long GetByACLCount(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList);
		[OperationContract]
		Services.Packages.Log.Security.ApplicationExceptionAccessControlList GetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry);
		[OperationContract]
		void SetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ACL);
		[OperationContract]
		ApplicationExceptionAccessControlEntryCollection GetEntries(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList);
		[OperationContract]
		ApplicationExceptionAccessControlEntryCollection GetEntriesPaged(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount);
		[OperationContract]
		long GetEntriesCount(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList);

    }
    
    /// <summary>
    /// WCF and default implementation of a service object for Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry type.
    /// </summary>
    [ComVisible(true)]
	[ClassInterface(ClassInterfaceType.None)]
    [Guid("567c8a92-5953-0760-d4a8-de33af6078fb")]
    ...
    sealed public class ApplicationExceptionAccessControlEntryService : IApplicationExceptionAccessControlEntryService
    {
		/// <summary>
		...
		[WebMethod]
        public bool Exists(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			return _ApplicationExceptionAccessControlEntry.Exists;
        }
		
		[WebMethod]
		public ApplicationExceptionAccessControlEntry Read(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
		{
			return new ApplicationExceptionAccessControlEntry(__Descriptor, __UserName, __Id);
		}
		
		[WebMethod]
        public ApplicationExceptionAccessControlEntry Reload(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			_ApplicationExceptionAccessControlEntry.Reload();
			return _ApplicationExceptionAccessControlEntry;
        }
		
		[WebMethod]
        public ApplicationExceptionAccessControlEntry Create(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
        {
			return ApplicationExceptionAccessControlEntry.CreateApplicationExceptionAccessControlEntry(__Descriptor, __UserName, __Id);
        }
        
        [WebMethod]
        public void Delete(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
        {
			ApplicationExceptionAccessControlEntry.DeleteApplicationExceptionAccessControlEntry(__Descriptor, __UserName, __Id);
        }
        
        [WebMethod]
        public void UpdateObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			_ApplicationExceptionAccessControlEntry.Update();
        }
		
		[WebMethod]
        public void CreateObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			_ApplicationExceptionAccessControlEntry.Create();
        }
        
        [WebMethod]
        public void DeleteObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			_ApplicationExceptionAccessControlEntry.Delete();
        }
		
		[WebMethod]
        public void Undo()
        {
			ApplicationExceptionAccessControlEntry.Undo();
        }
        
        [WebMethod]
        public void Redo()
        {
			ApplicationExceptionAccessControlEntry.Redo();
        }
		[WebMethod]
		public ApplicationExceptionAccessControlEntryCollection GetByACL(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
		{
			return ApplicationExceptionAccessControlEntry.GetByACL( _ApplicationExceptionAccessControlList);
		}
		[WebMethod]
		public ApplicationExceptionAccessControlEntryCollection GetByACLPaged(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount)
		{
			return ApplicationExceptionAccessControlEntry.GetByACLPaged( _ApplicationExceptionAccessControlList, PagingStart, PagingCount);
		}
		[WebMethod]
		public long GetByACLCount(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
		{
			return ApplicationExceptionAccessControlEntry.GetByACLCount( _ApplicationExceptionAccessControlList);
		}
		[WebMethod]
		public Services.Packages.Log.Security.ApplicationExceptionAccessControlList GetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
		{
			_ApplicationExceptionAccessControlEntry.Reload();
			return _ApplicationExceptionAccessControlEntry.ACL;
		}
		[WebMethod]
		public void SetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ACL)
		{
			_ApplicationExceptionAccessControlEntry.Reload();
			_ApplicationExceptionAccessControlEntry.ACL = _ACL;
			_ApplicationExceptionAccessControlEntry.Update();
		}
		[WebMethod]
		public ApplicationExceptionAccessControlEntryCollection GetEntries(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
		{
			return ApplicationExceptionAccessControlEntry.GetEntries(Descriptor,  _ApplicationExceptionAccessControlList);
		}
		[WebMethod]
		public ApplicationExceptionAccessControlEntryCollection GetEntriesPaged(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount)
		{
			return ApplicationExceptionAccessControlEntry.GetEntriesPaged(Descriptor,  _ApplicationExceptionAccessControlList, PagingStart, PagingCount);
		}
		[WebMethod]
		public long GetEntriesCount(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
		{
			return ApplicationExceptionAccessControlEntry.GetEntriesCount(Descriptor,  _ApplicationExceptionAccessControlList);
		}

    }
	
	/// <summary>
    /// Provides the implementation of Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry model that acts as DAL for
    /// a database table.
    /// </summary>
    [ComVisible(true)]
	[ClassInterface(ClassInterfaceType.None)]
    [Guid("908d608f-7a76-7994-a7a8-369d95035588")]
    [DataContract]
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
    [Serializable]
    public class ApplicationExceptionAccessControlEntry : IApplicationExceptionAccessControlEntry, IHierarchyData, global::Platform.Runtime.Data.IModelHierachyData
    {
		#region Servicing support

		// Synchronized replication
        [NonSerialized]
        static List<IApplicationExceptionAccessControlEntryService> replicationServices = null;
        
        // Scaling proxy objects (using 1 object you get forwarding)
        [NonSerialized]
        static List<IApplicationExceptionAccessControlEntryService> scalingServices = null;
		// static IServiceSelectionAlgorithm serviceSelectionAlgorithm = null;

        // Failover scenario
        [NonSerialized]
        static List<IApplicationExceptionAccessControlEntryService> failoverServices = null;
		...
		public static string ClassConnectionString
        {
            get
            {
				...
				if (global::System.Configuration.ConfigurationManager.ConnectionStrings["Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry"] != null)
					classConnectionString = global::System.Configuration.ConfigurationManager.ConnectionStrings["Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry"].ConnectionString;
		...
		public static global::Platform.Runtime.SqlProviderType ClassSqlProviderType
        {
            get
            {
				...
				classSqlProviderType = global::Platform.Runtime.Sql.GetProviderConfiguration("Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry.ProviderType");
		...
		Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ACL;
		
		
		[System.Xml.Serialization.XmlIgnoreAttribute]
		public Services.Packages.Log.Security.ApplicationExceptionAccessControlList ACL
		{
            get
            {
				if (!_ACLIsLoaded)
				{
					_ACL = new Services.Packages.Log.Security.ApplicationExceptionAccessControlList(_UserName, _Id);
					if (_ACL.Exists)
						_ACLIsLoaded = true;
					else _ACL = null;
				}
		...
		public static Services.Packages.Log.Security.ApplicationExceptionAccessControlList GetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
		{
			return _ApplicationExceptionAccessControlEntry.ACL;
		}

		public static ApplicationExceptionAccessControlEntryCollection GetByACL(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
        {
			ApplicationExceptionAccessControlEntryCollection _ApplicationExceptionAccessControlEntryCollection = new ApplicationExceptionAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("ApExAcCoEnGetByACL", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
                
                DbParameter param_UserName;
				if (_ApplicationExceptionAccessControlList != null) {
				param_UserName = ClassConnectionProvider.GetDatabaseParameter("UserName", typeof(System.String), 128);
				param_UserName.Value = ClassConnectionProvider.FromValueToSqlModelType(_ApplicationExceptionAccessControlList.UserName);
				} else {
				...
				param_Id.Value = ClassConnectionProvider.FromValueToSqlModelType(_ApplicationExceptionAccessControlList.Id);
				} else {
                ...
                while (dr.Read())
                {
					ApplicationExceptionAccessControlEntry o = new ApplicationExceptionAccessControlEntry();
				...
				if (dr["Id"] == DBNull.Value) { o._ACL = null; o._ACLIsLoaded = true; }  else o._Id = (System.Int32) global::Platform.Runtime.Utilities.FromSqlToValue(dr["Id"], typeof(System.Int32));
                    ...
                    _ApplicationExceptionAccessControlEntryCollection.Add(o);
                }

                dr.Close();
            }
            
            return _ApplicationExceptionAccessControlEntryCollection;
        }
        
        public static ApplicationExceptionAccessControlEntryCollection GetByACLPaged(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount)
        {
			ApplicationExceptionAccessControlEntryCollection _ApplicationExceptionAccessControlEntryCollection = new ApplicationExceptionAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("ApExAcCoEnGetByACLPaged", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public static long GetByACLCount(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
        {
			long count = 0;
            ...
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("ApExAcCoEnGetByACLCount", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
		...
		public static ApplicationExceptionAccessControlEntryCollection GetEntries(System.String _Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
        {
			ApplicationExceptionAccessControlEntryCollection _ApplicationExceptionAccessControlEntryCollection = new ApplicationExceptionAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("ApExAcCoEnGeEn", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
				...
				DbParameter param_ApplicationExceptionAccessControlList_UserName;
				if (_ApplicationExceptionAccessControlList != null) {
				param_ApplicationExceptionAccessControlList_UserName = ClassConnectionProvider.GetDatabaseParameter("ApExAcCoLiUsNa", typeof(System.String), 128);
				param_ApplicationExceptionAccessControlList_UserName.Value = ClassConnectionProvider.FromValueToSqlModelType(_ApplicationExceptionAccessControlList.UserName);
				} else {
				param_ApplicationExceptionAccessControlList_UserName = ClassConnectionProvider.GetDatabaseParameter("ApExAcCoLiUsNa", DBNull.Value);
				}
				command.Parameters.Add(param_ApplicationExceptionAccessControlList_UserName);
				DbParameter param_ApplicationExceptionAccessControlList_Id;
				if (_ApplicationExceptionAccessControlList != null) {
				param_ApplicationExceptionAccessControlList_Id = ClassConnectionProvider.GetDatabaseParameter("ApExAcCoLiId", typeof(System.Int32), -1);
				param_ApplicationExceptionAccessControlList_Id.Value = ClassConnectionProvider.FromValueToSqlModelType(_ApplicationExceptionAccessControlList.Id);
				} else {
				param_ApplicationExceptionAccessControlList_Id = ClassConnectionProvider.GetDatabaseParameter("ApExAcCoLiId", DBNull.Value);
				}
				command.Parameters.Add(param_ApplicationExceptionAccessControlList_Id);
        ...
        public static ApplicationExceptionAccessControlEntryCollection GetEntriesPaged(System.String _Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount)
        {
			ApplicationExceptionAccessControlEntryCollection _ApplicationExceptionAccessControlEntryCollection = new ApplicationExceptionAccessControlEntryCollection();
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("ApExAcCoEnGeEnPaged", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public static long GetEntriesCount(System.String _Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList)
        {
			long count = 0;
			// sql read
			using (DbConnection dbconn = ClassConnectionProvider.GetDatabaseConnection(ClassConnectionString))
            {
				dbconn.Open();
                DbCommand command = ClassConnectionProvider.GetDatabaseCommand("ApExAcCoEnGeEnCount", dbconn);
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public ApplicationExceptionAccessControlEntry() {}
        
        public ApplicationExceptionAccessControlEntry(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
        {
        ...
        void Exist()
        {
			...
			{
				dbconn.Open();
				DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("ApExAcCoEnRead", dbconn);
				command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public void Read(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
        {
			if (scalingServices != null)
            {
                ...
                // int nextIndex = serviceSelectionAlgorithm.Pick(scalingServices, "ApExAcCoEn");
        ...
        public void Reload()
        {
			if (scalingServices != null)
            {
                ...
                // Get a service via an algorithm
                // int nextIndex = serviceSelectionAlgorithm.GetNext(scalingServices, "ApExAcCoEn");
                // Perfect for read operations, but not for write
        ...
        public void Create()
        {
            ...
            {		
				if (!Exists)
				{
					...
					{
						dbconn.Open();
						DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("ApExAcCoEnCreate", dbconn);
						command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        static public ApplicationExceptionAccessControlEntry CreateApplicationExceptionAccessControlEntry(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
        {
            ApplicationExceptionAccessControlEntry o = new ApplicationExceptionAccessControlEntry(__Descriptor, __UserName, __Id);
        ...
        public void Update()
        {
            ...
            {			
				...
				{
					dbconn.Open();
					DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("ApExAcCoEnUpdate", dbconn);
					command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        public void Delete()
        {
            ...
            {			
				...
				{
					dbconn.Open();
					DbCommand command = InstanceConnectionProvider.GetDatabaseCommand("ApExAcCoEnDelete", dbconn);
					command.CommandType = global::System.Data.CommandType.StoredProcedure;
        ...
        static public void DeleteApplicationExceptionAccessControlEntry(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
        {
            ApplicationExceptionAccessControlEntry o = new ApplicationExceptionAccessControlEntry(__Descriptor, __UserName, __Id);
        ...
        public void CopyWithKeysFrom(ApplicationExceptionAccessControlEntry _object)
        {
			_ACL = null;
			_ACLIsLoaded = false;
        ...
        public void CopyWithKeysTo(ApplicationExceptionAccessControlEntry _object)
        {
			_object._ACL = null;
        ...
        static public void CopyWithKeysObject(ApplicationExceptionAccessControlEntry _objectFrom, ApplicationExceptionAccessControlEntry _objectTo)
        {
			_objectFrom.CopyWithKeysTo(_objectTo);
        }
        
        public void CopyFrom(ApplicationExceptionAccessControlEntry _object)
        {
			_ACL = null;
			_ACLIsLoaded = false;
			_Allow = _object._Allow;
        ...
        public void CopyTo(ApplicationExceptionAccessControlEntry _object)
        {
			_object._ACL = null;
			_object._ACLIsLoaded = false;
			_object._Allow = _Allow;
        ...
        static public void CopyObject(ApplicationExceptionAccessControlEntry _objectFrom, ApplicationExceptionAccessControlEntry _objectTo)
        {
		...
		public static bool IsUndoRedoSupported
		{
			get {
				if (!isUndoRedoSupportedHasBeenLoaded) {
                    ...
                    Platform.Module.UndoRedo.Services.Packages.UndoRedoOptions options = new Platform.Module.UndoRedo.Services.Packages.UndoRedoOptions(typeof(ApplicationExceptionAccessControlEntry).FullName);
                    if (!options.Exists)
                    {
		...
		static void MarkUndo(ApplicationExceptionAccessControlEntry _object, bool IsCreatedUndoDeletes, bool IsDeletedUndoCreates, bool IsUpdatedUndoUpdates)
        {
			// Delete already undone entries (steps that have been undone but not redone)
			ApplicationExceptionAccessControlEntryUndoRedoCollection allUndidAndNotRedoneEntries = ApplicationExceptionAccessControlEntryUndoRedo.GetAllFilterByIsUndone(true);
			for(int n = 0; n < allUndidAndNotRedoneEntries.Count; ++n)
				allUndidAndNotRedoneEntries[n].Delete();

			// Create one undo entry
			ApplicationExceptionAccessControlEntryUndoRedo _urobject = new ApplicationExceptionAccessControlEntryUndoRedo();
			...
			Platform.Module.UndoRedo.Services.Packages.Grouping.GroupEntry(typeof(ApplicationExceptionAccessControlEntry).FullName, _urobject.UndoRedoId);

			// Check if we have too many - if yes delete the oldest entry
			long count = ApplicationExceptionAccessControlEntryUndoRedo.GetAllWithNoFilterCount(true) - undoRedoMaximumObjects;
			if (count > 0)
			{
				ApplicationExceptionAccessControlEntryUndoRedoCollection allOldUndoEntries = ApplicationExceptionAccessControlEntryUndoRedo.GetAllWithNoFilterOppositeSortingPaged(true, 0, count);
		...
		static public void Undo()
        {
			...
			ApplicationExceptionAccessControlEntryUndoRedoCollection firstUndoEntries = ApplicationExceptionAccessControlEntryUndoRedo.GetAllFilterByIsUndonePaged(false, 0, 1);
			if (firstUndoEntries.Count < 1)
				return;

			ApplicationExceptionAccessControlEntryUndoRedo _urobject = firstUndoEntries[0];
			
			ApplicationExceptionAccessControlEntry _object = new ApplicationExceptionAccessControlEntry();
			_object._ACL = null;
			_object._ACLIsLoaded = false;
        ...
        static public void Redo()
        {
			...
			ApplicationExceptionAccessControlEntryUndoRedoCollection firstEntryToRedoEntries = ApplicationExceptionAccessControlEntryUndoRedo.GetAllFilterByIsUndoneOppositeOrderPaged(true, 0, 1);
			if (firstEntryToRedoEntries.Count < 1)
				return;

			ApplicationExceptionAccessControlEntryUndoRedo _urobject = firstEntryToRedoEntries[0];
    ...
    /// <summary>
    /// Defines the contract for the ApplicationExceptionAccessControlEntryCollection class
    /// </summary>
    [ComVisible(true)]
	[InterfaceType(ComInterfaceType.InterfaceIsDual)]
    [Guid("883e4e91-9196-0560-f341-65e172f212e6")]
    public interface IApplicationExceptionAccessControlEntryCollection : IEnumerable<ApplicationExceptionAccessControlEntry>
    {
        int IndexOf(ApplicationExceptionAccessControlEntry item);
        void Insert(int index, ApplicationExceptionAccessControlEntry item);
        void RemoveAt(int index);
        ApplicationExceptionAccessControlEntry this[int index] { get; set; }
        void Add(ApplicationExceptionAccessControlEntry item);
        void Clear();
        bool Contains(ApplicationExceptionAccessControlEntry item);
        void CopyTo(ApplicationExceptionAccessControlEntry[] array, int arrayIndex);
        int Count { get; }
        bool IsReadOnly { get; }
        bool Remove(ApplicationExceptionAccessControlEntry item);
    }

    /// <summary>
    /// Provides the implementation of the class that represents a list of Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry
    /// </summary>
    [ClassInterface(ClassInterfaceType.None)]
    [Guid("d22e9a9c-83fd-186c-f502-aeab23c371d0")]
    [DataContract]
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
    [Serializable]
    public class ApplicationExceptionAccessControlEntryCollection : IApplicationExceptionAccessControlEntryCollection, IList<ApplicationExceptionAccessControlEntry>, IHierarchicalEnumerable
    {
        List<ApplicationExceptionAccessControlEntry> _list = new List<ApplicationExceptionAccessControlEntry>();
        
        public static implicit operator List<ApplicationExceptionAccessControlEntry>(ApplicationExceptionAccessControlEntryCollection collection)
        {
            return collection._list;
        }

        #region IList<ApplicationExceptionAccessControlEntry> Members

        public int IndexOf(ApplicationExceptionAccessControlEntry item)
        {
            return _list.IndexOf(item);
        }

        public void Insert(int index, ApplicationExceptionAccessControlEntry item)
        {
        ...
        public ApplicationExceptionAccessControlEntry this[int index]
        {
            get
            {
                return _list[index];
        ...
        #region ICollection<ApplicationExceptionAccessControlEntry> Members

        public void Add(ApplicationExceptionAccessControlEntry item)
        {
            _list.Add(item);
        }
        ...
        public bool Contains(ApplicationExceptionAccessControlEntry item)
        {
            return _list.Contains(item);
        }

        public void CopyTo(ApplicationExceptionAccessControlEntry[] array, int arrayIndex)
        {
        ...
        public bool Remove(ApplicationExceptionAccessControlEntry item)
        {
        ...
        #region IEnumerable<ApplicationExceptionAccessControlEntry> Members

        public IEnumerator<ApplicationExceptionAccessControlEntry> GetEnumerator()
        {
...
namespace Web
{
	...
	/// that share Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry objects.
	/// </summary>
    /// <example>
    /// You can use that in the header of an asmx file like this:
    /// <%@ WebService Language="C#" Class="Services.Packages.Log.Security.Web.ApplicationExceptionAccessControlEntryWebService" %>
    /// </example>
	...
	[global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
	[ComVisible(false)]
    sealed public class ApplicationExceptionAccessControlEntryWebService : WebService, IApplicationExceptionAccessControlEntryService
	{
		/// <summary>
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="ApplicationExceptionAccessControlEntryWebServiceSoap", Namespace="http://services.msd.com")]
	[System.Xml.Serialization.XmlIncludeAttribute(typeof(MarshalByRefObject))]
	[ComVisible(true)]
	[ClassInterface(ClassInterfaceType.None)]
    [Guid("61a25652-ef22-fe64-0087-9d3514b207b5")]
    sealed public class ApplicationExceptionAccessControlEntryWebServiceClient : System.Web.Services.Protocols.SoapHttpClientProtocol, IApplicationExceptionAccessControlEntryService
	{
		...
		public ApplicationExceptionAccessControlEntryWebServiceClient(string url)
		{
			this.Url = url;
		}
        ...
        /// </summary>
		public ApplicationExceptionAccessControlEntryWebServiceClient()
		{
		...
		public bool Exists(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			object[] results = this.Invoke("Exists", new object[] {_ApplicationExceptionAccessControlEntry});
		...
		public ApplicationExceptionAccessControlEntry Read(System.String __Descriptor, System.String __UserName, System.Int32 __Id)
		{
			...
			return ((ApplicationExceptionAccessControlEntry)(results[0]));
		}
		...
		public ApplicationExceptionAccessControlEntry Reload(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			object[] results = this.Invoke("Reload", new object[] {_ApplicationExceptionAccessControlEntry});
			return ((ApplicationExceptionAccessControlEntry)(results[0]));
        }
        ...
        public void UpdateObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			this.Invoke("UpdateObject", new object[] {_ApplicationExceptionAccessControlEntry});
			return;
        }
		...
		public void CreateObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			this.Invoke("CreateObject", new object[] {_ApplicationExceptionAccessControlEntry});
			return;
        }
        ...
        public void DeleteObject(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
        {
			this.Invoke("DeleteObject", new object[] {_ApplicationExceptionAccessControlEntry});
			return;
        }
		...
		public ApplicationExceptionAccessControlEntryCollection GetByACL(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList) {
			object[] results = this.Invoke("GetByACL", new object[] {_ApplicationExceptionAccessControlList});
			return ((ApplicationExceptionAccessControlEntryCollection)(results[0]));
		}
		...
		public ApplicationExceptionAccessControlEntryCollection GetByACLPaged(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount) {
			object[] results = this.Invoke("GetByACLPaged", new object[] {_ApplicationExceptionAccessControlList,PagingStart,PagingCount});
			return ((ApplicationExceptionAccessControlEntryCollection)(results[0]));
		}
		...
		public long GetByACLCount(Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList) {
			object[] results = this.Invoke("GetByACLCount", new object[] {_ApplicationExceptionAccessControlList});
		...
		public Services.Packages.Log.Security.ApplicationExceptionAccessControlList GetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry)
		{
			object[] results = this.Invoke("GetACL", new object[] {_ApplicationExceptionAccessControlEntry});
			return ((Services.Packages.Log.Security.ApplicationExceptionAccessControlList)(results[0]));
		}
		...
		public void SetACL(ApplicationExceptionAccessControlEntry _ApplicationExceptionAccessControlEntry, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ACL)
		{
			this.Invoke("GetACL", new object[] {_ApplicationExceptionAccessControlEntry});
			return;
		}
		...
		public ApplicationExceptionAccessControlEntryCollection GetEntries(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList) {
			object[] results = this.Invoke("GetEntries", new object[] {Descriptor, _ApplicationExceptionAccessControlList});
			return ((ApplicationExceptionAccessControlEntryCollection)(results[0]));
		}
		...
		public ApplicationExceptionAccessControlEntryCollection GetEntriesPaged(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList, long PagingStart, long PagingCount) {
			object[] results = this.Invoke("GetEntriesPaged", new object[] {Descriptor, _ApplicationExceptionAccessControlList,PagingStart,PagingCount});
			return ((ApplicationExceptionAccessControlEntryCollection)(results[0]));
		}
		...
		public long GetEntriesCount(System.String Descriptor, Services.Packages.Log.Security.ApplicationExceptionAccessControlList _ApplicationExceptionAccessControlList) {
			object[] results = this.Invoke("GetEntriesCount", new object[] {Descriptor, _ApplicationExceptionAccessControlList});
			return ((long)(results[0]));
		}
