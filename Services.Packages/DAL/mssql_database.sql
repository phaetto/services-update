...
IF (OBJECT_ID('[dbo].[FK.ApKe:ApKe:Pa]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Package] DROP CONSTRAINT [FK.ApKe:ApKe:Pa]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:Pa]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Package] DROP CONSTRAINT [FK.MoUs:Ow:Pa]

/** Services.Packages.LocalPackage DROP FKs sp's **/

/** Services.Packages.ApiKey DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.Cu:Cu:ApKe]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.ApiKey] DROP CONSTRAINT [FK.Cu:Cu:ApKe]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:ApKe]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.ApiKey] DROP CONSTRAINT [FK.MoUs:Ow:ApKe]

/** Services.Packages.Log.ApplicationException DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.ApKe:ApKe:ApEx]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Log.ApplicationException] DROP CONSTRAINT [FK.ApKe:ApKe:ApEx]

IF (OBJECT_ID('[dbo].[FK.ApEx:PaEx:ApEx]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Log.ApplicationException] DROP CONSTRAINT [FK.ApEx:PaEx:ApEx]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:ApEx]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Log.ApplicationException] DROP CONSTRAINT [FK.MoUs:Ow:ApEx]

/** Services.Packages.Customer DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.Cu:Pa:Cu]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Customer] DROP CONSTRAINT [FK.Cu:Pa:Cu]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:Cu]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Customer] DROP CONSTRAINT [FK.MoUs:Ow:Cu]

/** Services.Packages.CustomerUserEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:UsLo:CuUsEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.CustomerUserEntry] DROP CONSTRAINT [FK.MoUs:UsLo:CuUsEn]

IF (OBJECT_ID('[dbo].[FK.Cu:Cu:CuUsEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.CustomerUserEntry] DROP CONSTRAINT [FK.Cu:Cu:CuUsEn]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:CuUsEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.CustomerUserEntry] DROP CONSTRAINT [FK.MoUs:Ow:CuUsEn]

/** Services.Packages.Purchase DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.ApKe:ApKe:Pu]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Purchase] DROP CONSTRAINT [FK.ApKe:ApKe:Pu]

IF (OBJECT_ID('[dbo].[FK.MoUs:Cl:Pu]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Purchase] DROP CONSTRAINT [FK.MoUs:Cl:Pu]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:Pu]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Purchase] DROP CONSTRAINT [FK.MoUs:Ow:Pu]

/** Services.Packages.PurchaseLine DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.Pu:PuOr:PuLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.PurchaseLine] DROP CONSTRAINT [FK.Pu:PuOr:PuLi]

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:PuLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.PurchaseLine] DROP CONSTRAINT [FK.MoUs:Ow:PuLi]

/** Services.Packages.Security.ModelUser DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Ow:MoUs]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.ModelUser] DROP CONSTRAINT [FK.MoUs:Ow:MoUs]

/** Services.Packages.Security.ModelSession DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:MoSe]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.ModelSession] DROP CONSTRAINT [FK.MoUs:Us:MoSe]

/** Services.Packages.Security.ModelUserRights DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:MoUsRi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.ModelUserRights] DROP CONSTRAINT [FK.MoUs:Us:MoUsRi]
...
IF (OBJECT_ID('[dbo].[FK.IPRe:IP:IPSeRe]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.IPSessionRegistration] DROP CONSTRAINT [FK.IPRe:IP:IPSeRe]

IF (OBJECT_ID('[dbo].[FK.MoSe:Se:IPSeRe]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.IPSessionRegistration] DROP CONSTRAINT [FK.MoSe:Se:IPSeRe]

/** Services.Packages.Security.PackageAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:PaAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PackageAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:PaAcCoLi]

IF (OBJECT_ID('[dbo].[FK.Pa:Pa:PaAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PackageAccessControlList] DROP CONSTRAINT [FK.Pa:Pa:PaAcCoLi]

/** Services.Packages.Security.PackageAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.PaAcCoLi:ACL:PaAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PackageAccessControlEntry] DROP CONSTRAINT [FK.PaAcCoLi:ACL:PaAcCoEn]

/** Services.Packages.Security.ApiKeyAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:ApKeAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.ApiKeyAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:ApKeAcCoLi]

IF (OBJECT_ID('[dbo].[FK.ApKe:ApKe:ApKeAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.ApiKeyAccessControlList] DROP CONSTRAINT [FK.ApKe:ApKe:ApKeAcCoLi]

/** Services.Packages.Security.ApiKeyAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.ApKeAcCoLi:ACL:ApKeAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.ApiKeyAccessControlEntry] DROP CONSTRAINT [FK.ApKeAcCoLi:ACL:ApKeAcCoEn]

/** Services.Packages.Log.Security.ApplicationExceptionAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:ApExAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Log.Security.ApplicationExceptionAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:ApExAcCoLi]

IF (OBJECT_ID('[dbo].[FK.ApEx:ApEx:ApExAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Log.Security.ApplicationExceptionAccessControlList] DROP CONSTRAINT [FK.ApEx:ApEx:ApExAcCoLi]

/** Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.ApExAcCoLi:ACL:ApExAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry] DROP CONSTRAINT [FK.ApExAcCoLi:ACL:ApExAcCoEn]

/** Services.Packages.Security.CustomerAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:CuAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.CustomerAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:CuAcCoLi]

IF (OBJECT_ID('[dbo].[FK.Cu:Cu:CuAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.CustomerAccessControlList] DROP CONSTRAINT [FK.Cu:Cu:CuAcCoLi]

/** Services.Packages.Security.CustomerAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.CuAcCoLi:ACL:CuAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.CustomerAccessControlEntry] DROP CONSTRAINT [FK.CuAcCoLi:ACL:CuAcCoEn]

/** Services.Packages.Security.CustomerUserEntryAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:CuUsEnAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.CustomerUserEntryAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:CuUsEnAcCoLi]

IF (OBJECT_ID('[dbo].[FK.CuUsEn:CuUsEn:CuUsEnAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.CustomerUserEntryAccessControlList] DROP CONSTRAINT [FK.CuUsEn:CuUsEn:CuUsEnAcCoLi]

/** Services.Packages.Security.CustomerUserEntryAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.CuUsEnAcCoLi:ACL:CuUsEnAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.CustomerUserEntryAccessControlEntry] DROP CONSTRAINT [FK.CuUsEnAcCoLi:ACL:CuUsEnAcCoEn]

/** Services.Packages.Security.PurchaseAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:PuAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PurchaseAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:PuAcCoLi]

IF (OBJECT_ID('[dbo].[FK.Pu:Pu:PuAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PurchaseAccessControlList] DROP CONSTRAINT [FK.Pu:Pu:PuAcCoLi]

/** Services.Packages.Security.PurchaseAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.PuAcCoLi:ACL:PuAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PurchaseAccessControlEntry] DROP CONSTRAINT [FK.PuAcCoLi:ACL:PuAcCoEn]

/** Services.Packages.Security.PurchaseLineAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:PuLiAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PurchaseLineAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:PuLiAcCoLi]

IF (OBJECT_ID('[dbo].[FK.PuLi:PuLi:PuLiAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PurchaseLineAccessControlList] DROP CONSTRAINT [FK.PuLi:PuLi:PuLiAcCoLi]

/** Services.Packages.Security.PurchaseLineAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.PuLiAcCoLi:ACL:PuLiAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.PurchaseLineAccessControlEntry] DROP CONSTRAINT [FK.PuLiAcCoLi:ACL:PuLiAcCoEn]

/** Services.Packages.Security.Security.ModelUserAccessControlList DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUs:Us:MoUsAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.Security.ModelUserAccessControlList] DROP CONSTRAINT [FK.MoUs:Us:MoUsAcCoLi]

IF (OBJECT_ID('[dbo].[FK.MoUs:MoUs:MoUsAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.Security.ModelUserAccessControlList] DROP CONSTRAINT [FK.MoUs:MoUs:MoUsAcCoLi]

/** Services.Packages.Security.Security.ModelUserAccessControlEntry DROP FKs sp's **/

IF (OBJECT_ID('[dbo].[FK.MoUsAcCoLi:ACL:MoUsAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[Services.Packages.Security.Security.ModelUserAccessControlEntry] DROP CONSTRAINT [FK.MoUsAcCoLi:ACL:MoUsAcCoEn]
...
IF (OBJECT_ID('[dbo].[PK.SePaPa]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaPa] DROP CONSTRAINT [PK.SePaPa]

/** Services.Packages.LocalPackage DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaLoPa]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaLoPa] DROP CONSTRAINT [PK.SePaLoPa]

/** Services.Packages.ApiKey DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaApKe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaApKe] DROP CONSTRAINT [PK.SePaApKe]

/** Services.Packages.Log.ApplicationException DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaLoApEx]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaLoApEx] DROP CONSTRAINT [PK.SePaLoApEx]

/** Services.Packages.Customer DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaCu]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaCu] DROP CONSTRAINT [PK.SePaCu]

/** Services.Packages.CustomerUserEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaCuUsEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaCuUsEn] DROP CONSTRAINT [PK.SePaCuUsEn]

/** Services.Packages.Purchase DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaPu]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaPu] DROP CONSTRAINT [PK.SePaPu]

/** Services.Packages.PurchaseLine DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaPuLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaPuLi] DROP CONSTRAINT [PK.SePaPuLi]

/** Services.Packages.Security.ModelUser DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeMoUs]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeMoUs] DROP CONSTRAINT [PK.SePaSeMoUs]

/** Services.Packages.Security.ModelSession DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeMoSe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeMoSe] DROP CONSTRAINT [PK.SePaSeMoSe]

/** Services.Packages.Security.ModelUserRights DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeMoUsRi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeMoUsRi] DROP CONSTRAINT [PK.SePaSeMoUsRi]

/** Services.Packages.Security.Securable DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeSe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeSe] DROP CONSTRAINT [PK.SePaSeSe]

/** Services.Packages.Security.IPRegistered DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeIPRe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeIPRe] DROP CONSTRAINT [PK.SePaSeIPRe]

/** Services.Packages.Security.IPSessionRegistration DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeIPSeRe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeIPSeRe] DROP CONSTRAINT [PK.SePaSeIPSeRe]

/** Services.Packages.Security.PackageAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSePaAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSePaAcCoLi] DROP CONSTRAINT [PK.SePaSePaAcCoLi]

/** Services.Packages.Security.PackageAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSePaAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSePaAcCoEn] DROP CONSTRAINT [PK.SePaSePaAcCoEn]

/** Services.Packages.Security.ApiKeyAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeApKeAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeApKeAcCoLi] DROP CONSTRAINT [PK.SePaSeApKeAcCoLi]

/** Services.Packages.Security.ApiKeyAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeApKeAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeApKeAcCoEn] DROP CONSTRAINT [PK.SePaSeApKeAcCoEn]

/** Services.Packages.Log.Security.ApplicationExceptionAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaLoSeApExAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaLoSeApExAcCoLi] DROP CONSTRAINT [PK.SePaLoSeApExAcCoLi]

/** Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaLoSeApExAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaLoSeApExAcCoEn] DROP CONSTRAINT [PK.SePaLoSeApExAcCoEn]

/** Services.Packages.Security.CustomerAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeCuAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeCuAcCoLi] DROP CONSTRAINT [PK.SePaSeCuAcCoLi]

/** Services.Packages.Security.CustomerAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeCuAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeCuAcCoEn] DROP CONSTRAINT [PK.SePaSeCuAcCoEn]

/** Services.Packages.Security.CustomerUserEntryAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeCuUsEnAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeCuUsEnAcCoLi] DROP CONSTRAINT [PK.SePaSeCuUsEnAcCoLi]

/** Services.Packages.Security.CustomerUserEntryAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeCuUsEnAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeCuUsEnAcCoEn] DROP CONSTRAINT [PK.SePaSeCuUsEnAcCoEn]

/** Services.Packages.Security.PurchaseAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSePuAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSePuAcCoLi] DROP CONSTRAINT [PK.SePaSePuAcCoLi]

/** Services.Packages.Security.PurchaseAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSePuAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSePuAcCoEn] DROP CONSTRAINT [PK.SePaSePuAcCoEn]

/** Services.Packages.Security.PurchaseLineAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSePuLiAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSePuLiAcCoLi] DROP CONSTRAINT [PK.SePaSePuLiAcCoLi]

/** Services.Packages.Security.PurchaseLineAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSePuLiAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSePuLiAcCoEn] DROP CONSTRAINT [PK.SePaSePuLiAcCoEn]

/** Services.Packages.Security.Security.ModelUserAccessControlList DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeSeMoUsAcCoLi]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeSeMoUsAcCoLi] DROP CONSTRAINT [PK.SePaSeSeMoUsAcCoLi]

/** Services.Packages.Security.Security.ModelUserAccessControlEntry DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaSeSeMoUsAcCoEn]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaSeSeMoUsAcCoEn] DROP CONSTRAINT [PK.SePaSeSeMoUsAcCoEn]

/** Platform.Module.UndoRedo.Services.Packages.UndoRedoOptions DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.PlMoUnReSePaUnReOp]') IS NOT NULL)
	ALTER TABLE [dbo].[PlMoUnReSePaUnReOp] DROP CONSTRAINT [PK.PlMoUnReSePaUnReOp]

/** Platform.Module.UndoRedo.Services.Packages.UndoRedoGroup DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.PlMoUnReSePaUnReGr]') IS NOT NULL)
	ALTER TABLE [dbo].[PlMoUnReSePaUnReGr] DROP CONSTRAINT [PK.PlMoUnReSePaUnReGr]

/** Services.Packages.CustomerUndoRedo DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaCuUnRe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaCuUnRe] DROP CONSTRAINT [PK.SePaCuUnRe]

/** Services.Packages.PurchaseUndoRedo DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaPuUnRe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaPuUnRe] DROP CONSTRAINT [PK.SePaPuUnRe]

/** Services.Packages.PurchaseLineUndoRedo DROP PKs sp's **/

IF (OBJECT_ID('[dbo].[PK.SePaPuLiUnRe]') IS NOT NULL)
	ALTER TABLE [dbo].[SePaPuLiUnRe] DROP CONSTRAINT [PK.SePaPuLiUnRe]

/** Services.Packages.Package Tables **/
IF (OBJECT_ID('[dbo].[SePaPa]') IS NOT NULL)
	DROP TABLE [dbo].[SePaPa];


IF (OBJECT_ID('[dbo].[SePaPa]') IS NULL)
	CREATE TABLE [dbo].[SePaPa] ( [Id] [int] IDENTITY(1,1) NOT NULL, [PackageName] [nvarchar](1024) NULL, [VersionLabel] [nvarchar](1024) NULL, [UploadDate] [datetime] NULL, [ApiKey_Id] [uniqueidentifier] NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaLoPa]') IS NOT NULL)
	DROP TABLE [dbo].[SePaLoPa];


IF (OBJECT_ID('[dbo].[SePaLoPa]') IS NULL)
	CREATE TABLE [dbo].[SePaLoPa] ( [PackageName] [nvarchar](1024) NOT NULL, [Id] [int] NULL, [VersionLabel] [nvarchar](1024) NULL );
...
IF (OBJECT_ID('[dbo].[SePaApKe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaApKe];


IF (OBJECT_ID('[dbo].[SePaApKe]') IS NULL)
	CREATE TABLE [dbo].[SePaApKe] ( [Id] [uniqueidentifier] NOT NULL, [CompanyInfo] [nvarchar](1024) NULL, [IssueDate] [datetime] NULL, [FromDate] [datetime] NULL, [ToDate] [datetime] NULL, [IsTest] [bit] NULL, [Customer_Name] [nvarchar](256) NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaLoApEx]') IS NOT NULL)
	DROP TABLE [dbo].[SePaLoApEx];


IF (OBJECT_ID('[dbo].[SePaLoApEx]') IS NULL)
	CREATE TABLE [dbo].[SePaLoApEx] ( [Id] [int] IDENTITY(1,1) NOT NULL, [Message] [nvarchar](512) NULL, [Source] [nvarchar](512) NULL, [StackTrace] [ntext] NULL, [Page] [ntext] NULL, [OnDate] [datetime] NULL, [IsSolved] [bit] NULL, [ApiKey_Id] [uniqueidentifier] NULL, [ParentException_Id] [int] NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaCu]') IS NOT NULL)
	DROP TABLE [dbo].[SePaCu];


IF (OBJECT_ID('[dbo].[SePaCu]') IS NULL)
	CREATE TABLE [dbo].[SePaCu] ( [Name] [nvarchar](256) NOT NULL, [FullNameOfResponsible] [nvarchar](512) NULL, [EmailOfResponsible] [nvarchar](256) NULL, [Description] [nvarchar](256) NULL, [IsPartner] [bit] NULL, [CompanyName] [nvarchar](256) NULL, [VATNo] [nvarchar](256) NULL, [Phone] [nvarchar](128) NULL, [Address] [nvarchar](256) NULL, [PostCode] [nvarchar](64) NULL, [City] [nvarchar](128) NULL, [Country] [nvarchar](256) NULL, [InvoiceAddress] [nvarchar](256) NULL, [InvoicePostCode] [nvarchar](64) NULL, [InvoiceCity] [nvarchar](128) NULL, [InvoiceCountry] [nvarchar](256) NULL, [IsPaymentAccepted] [bit] NULL, [LastPaymentDate] [datetime] NULL, [Partner_Name] [nvarchar](256) NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaCuUsEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaCuUsEn];


IF (OBJECT_ID('[dbo].[SePaCuUsEn]') IS NULL)
	CREATE TABLE [dbo].[SePaCuUsEn] ( [Id] [int] IDENTITY(1,1) NOT NULL, [UserLogin_Name] [nvarchar](128) NULL, [Customer_Name] [nvarchar](256) NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaPu]') IS NOT NULL)
	DROP TABLE [dbo].[SePaPu];


IF (OBJECT_ID('[dbo].[SePaPu]') IS NULL)
	CREATE TABLE [dbo].[SePaPu] ( [Id] [int] IDENTITY(1,1) NOT NULL, [CreationDate] [datetime] NULL, [ApiKey_Id] [uniqueidentifier] NULL, [Client_Name] [nvarchar](128) NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaPuLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaPuLi];


IF (OBJECT_ID('[dbo].[SePaPuLi]') IS NULL)
	CREATE TABLE [dbo].[SePaPuLi] ( [Id] [int] IDENTITY(1,1) NOT NULL, [ProductKey] [nvarchar](256) NULL, [ProductDescription] [ntext] NULL, [PricePurchased] [float] NULL, [RecurrentFeePurchased] [float] NULL, [IsPaid] [bit] NULL, [PurchaseOrder_Id] [int] NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeMoUs]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeMoUs];


IF (OBJECT_ID('[dbo].[SePaSeMoUs]') IS NULL)
	CREATE TABLE [dbo].[SePaSeMoUs] ( [Name] [nvarchar](128) NOT NULL, [PasswordHash] [nvarchar](256) NULL, [Email] [nvarchar](256) NULL, [Enabled] [bit] NULL, [SecretQuestion] [nvarchar](512) NULL, [SecretAnswer] [nvarchar](512) NULL, [Owner_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeMoSe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeMoSe];


IF (OBJECT_ID('[dbo].[SePaSeMoSe]') IS NULL)
	CREATE TABLE [dbo].[SePaSeMoSe] ( [SessionToken] [nvarchar](384) NOT NULL, [TimeIssued] [datetime] NULL, [TimeIssuedFor] [int] NULL, [User_Name] [nvarchar](128) NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeMoUsRi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeMoUsRi];
...
IF (OBJECT_ID('[dbo].[SePaSeSe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeSe];


IF (OBJECT_ID('[dbo].[SePaSeSe]') IS NULL)
	CREATE TABLE [dbo].[SePaSeSe] ( [Type] [nvarchar](256) NOT NULL, [Enabled] [bit] NULL, [TimeSessionIsIssued] [int] NULL, [AllowAnonymousAccess] [bit] NULL, [GenerationPasswordLength] [int] NULL, [IPsMustBePreregistered] [bit] NULL, [AllowedIPFailures] [int] NULL, [IPFailureTimeDenying] [int] NULL, [DisableIPFiltering] [bit] NULL, [SessionsPerIPAllowed] [int] NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeIPRe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeIPRe];


IF (OBJECT_ID('[dbo].[SePaSeIPRe]') IS NULL)
	CREATE TABLE [dbo].[SePaSeIPRe] ( [IP] [nvarchar](64) NOT NULL, [Allowed] [bit] NULL, [Failures] [int] NULL, [DenialIssuedUntilTime] [datetime] NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeIPSeRe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeIPSeRe];


IF (OBJECT_ID('[dbo].[SePaSeIPSeRe]') IS NULL)
	CREATE TABLE [dbo].[SePaSeIPSeRe] ( [HostName] [nvarchar](128) NOT NULL, [UserAgent] [nvarchar](128) NOT NULL, [IP_IP] [nvarchar](64) NULL, [Session_SessionToken] [nvarchar](384) NULL );
...
IF (OBJECT_ID('[dbo].[SePaSePaAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSePaAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSePaAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSePaAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSePaAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSePaAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Id] [int] NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeApKeAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeApKeAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSeApKeAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeApKeAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSeApKeAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSeApKeAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Id] [uniqueidentifier] NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaLoSeApExAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaLoSeApExAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaLoSeApExAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaLoSeApExAcCoEn];


IF (OBJECT_ID('[dbo].[SePaLoSeApExAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaLoSeApExAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Id] [int] NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeCuAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeCuAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSeCuAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeCuAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSeCuAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSeCuAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Name] [nvarchar](256) NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeCuUsEnAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeCuUsEnAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSeCuUsEnAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeCuUsEnAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSeCuUsEnAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSeCuUsEnAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Id] [int] NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaSePuAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSePuAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSePuAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSePuAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSePuAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSePuAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Id] [int] NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaSePuLiAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSePuLiAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSePuLiAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSePuLiAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSePuLiAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSePuLiAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Id] [int] NOT NULL );
...
IF (OBJECT_ID('[dbo].[SePaSeSeMoUsAcCoLi]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeSeMoUsAcCoLi];
...
IF (OBJECT_ID('[dbo].[SePaSeSeMoUsAcCoEn]') IS NOT NULL)
	DROP TABLE [dbo].[SePaSeSeMoUsAcCoEn];


IF (OBJECT_ID('[dbo].[SePaSeSeMoUsAcCoEn]') IS NULL)
	CREATE TABLE [dbo].[SePaSeSeMoUsAcCoEn] ( [Descriptor] [nvarchar](128) NOT NULL, [UserName] [nvarchar](128) NOT NULL, [Allow] [bit] NULL, [Name] [nvarchar](128) NOT NULL );
...
IF (OBJECT_ID('[dbo].[PlMoUnReSePaUnReOp]') IS NOT NULL)
	DROP TABLE [dbo].[PlMoUnReSePaUnReOp];


IF (OBJECT_ID('[dbo].[PlMoUnReSePaUnReOp]') IS NULL)
	CREATE TABLE [dbo].[PlMoUnReSePaUnReOp] ( [EntityType] [nvarchar](128) NOT NULL, [ItemsAllowed] [bigint] NULL, [IsEnabled] [bit] NULL );
...
IF (OBJECT_ID('[dbo].[PlMoUnReSePaUnReGr]') IS NOT NULL)
	DROP TABLE [dbo].[PlMoUnReSePaUnReGr];


IF (OBJECT_ID('[dbo].[PlMoUnReSePaUnReGr]') IS NULL)
	CREATE TABLE [dbo].[PlMoUnReSePaUnReGr] ( [Id] [bigint] IDENTITY(1,1) NOT NULL, [EntryName] [nvarchar](128) NULL, [UndoRedoEntityType] [nvarchar](128) NOT NULL, [UndoRedoRecordId] [bigint] NULL );
...
IF (OBJECT_ID('[dbo].[SePaCuUnRe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaCuUnRe];


IF (OBJECT_ID('[dbo].[SePaCuUnRe]') IS NULL)
	CREATE TABLE [dbo].[SePaCuUnRe] ( [UndoRedoId] [bigint] IDENTITY(1,1) NOT NULL, [IsCreatedUndoDeletes] [bit] NULL, [IsDeletedUndoCreates] [bit] NULL, [IsUpdatedUndoUpdates] [bit] NULL, [IsUndone] [bit] NULL, [Name] [nvarchar](256) NULL, [FullNameOfResponsible] [nvarchar](512) NULL, [EmailOfResponsible] [nvarchar](256) NULL, [Description] [nvarchar](256) NULL, [IsPartner] [bit] NULL, [CompanyName] [nvarchar](256) NULL, [VATNo] [nvarchar](256) NULL, [Phone] [nvarchar](128) NULL, [Address] [nvarchar](256) NULL, [PostCode] [nvarchar](64) NULL, [City] [nvarchar](128) NULL, [Country] [nvarchar](256) NULL, [InvoiceAddress] [nvarchar](256) NULL, [InvoicePostCode] [nvarchar](64) NULL, [InvoiceCity] [nvarchar](128) NULL, [InvoiceCountry] [nvarchar](256) NULL, [IsPaymentAccepted] [bit] NULL, [LastPaymentDate] [datetime] NULL, [Partner_Name] [ntext] NULL, [Owner_Name] [ntext] NULL );
...
IF (OBJECT_ID('[dbo].[SePaPuUnRe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaPuUnRe];


IF (OBJECT_ID('[dbo].[SePaPuUnRe]') IS NULL)
	CREATE TABLE [dbo].[SePaPuUnRe] ( [UndoRedoId] [bigint] IDENTITY(1,1) NOT NULL, [IsCreatedUndoDeletes] [bit] NULL, [IsDeletedUndoCreates] [bit] NULL, [IsUpdatedUndoUpdates] [bit] NULL, [IsUndone] [bit] NULL, [Id] [int] NULL, [CreationDate] [datetime] NULL, [ApiKey_Id] [uniqueidentifier] NULL, [Client_Name] [ntext] NULL, [Owner_Name] [ntext] NULL );
...
IF (OBJECT_ID('[dbo].[SePaPuLiUnRe]') IS NOT NULL)
	DROP TABLE [dbo].[SePaPuLiUnRe];


IF (OBJECT_ID('[dbo].[SePaPuLiUnRe]') IS NULL)
	CREATE TABLE [dbo].[SePaPuLiUnRe] ( [UndoRedoId] [bigint] IDENTITY(1,1) NOT NULL, [IsCreatedUndoDeletes] [bit] NULL, [IsDeletedUndoCreates] [bit] NULL, [IsUpdatedUndoUpdates] [bit] NULL, [IsUndone] [bit] NULL, [Id] [int] NULL, [ProductKey] [nvarchar](256) NULL, [ProductDescription] [ntext] NULL, [PricePurchased] [float] NULL, [RecurrentFeePurchased] [float] NULL, [IsPaid] [bit] NULL, [PurchaseOrder_Id] [int] NULL, [Owner_Name] [ntext] NULL );
...
ALTER TABLE [dbo].[SePaPa] ADD CONSTRAINT [FK.ApKe:ApKe:Pa] FOREIGN KEY
	([ApiKey_Id]) REFERENCES [Services.Packages.ApiKey] ([Id]);
GO


ALTER TABLE [dbo].[SePaPa] ADD CONSTRAINT [FK.MoUs:Ow:Pa] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaApKe] ADD CONSTRAINT [FK.Cu:Cu:ApKe] FOREIGN KEY
	([Customer_Name]) REFERENCES [Services.Packages.Customer] ([Name]);
GO


ALTER TABLE [dbo].[SePaApKe] ADD CONSTRAINT [FK.MoUs:Ow:ApKe] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaLoApEx] ADD CONSTRAINT [FK.ApKe:ApKe:ApEx] FOREIGN KEY
	([ApiKey_Id]) REFERENCES [Services.Packages.ApiKey] ([Id]);
GO


ALTER TABLE [dbo].[SePaLoApEx] ADD CONSTRAINT [FK.ApEx:PaEx:ApEx] FOREIGN KEY
	([ParentException_Id]) REFERENCES [Services.Packages.Log.ApplicationException] ([Id]);
GO


ALTER TABLE [dbo].[SePaLoApEx] ADD CONSTRAINT [FK.MoUs:Ow:ApEx] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaCu] ADD CONSTRAINT [FK.Cu:Pa:Cu] FOREIGN KEY
	([Partner_Name]) REFERENCES [Services.Packages.Customer] ([Name]);
GO


ALTER TABLE [dbo].[SePaCu] ADD CONSTRAINT [FK.MoUs:Ow:Cu] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaCuUsEn] ADD CONSTRAINT [FK.MoUs:UsLo:CuUsEn] FOREIGN KEY
	([UserLogin_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaCuUsEn] ADD CONSTRAINT [FK.Cu:Cu:CuUsEn] FOREIGN KEY
	([Customer_Name]) REFERENCES [Services.Packages.Customer] ([Name]);
GO


ALTER TABLE [dbo].[SePaCuUsEn] ADD CONSTRAINT [FK.MoUs:Ow:CuUsEn] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaPu] ADD CONSTRAINT [FK.ApKe:ApKe:Pu] FOREIGN KEY
	([ApiKey_Id]) REFERENCES [Services.Packages.ApiKey] ([Id]);
GO


ALTER TABLE [dbo].[SePaPu] ADD CONSTRAINT [FK.MoUs:Cl:Pu] FOREIGN KEY
	([Client_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaPu] ADD CONSTRAINT [FK.MoUs:Ow:Pu] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaPuLi] ADD CONSTRAINT [FK.Pu:PuOr:PuLi] FOREIGN KEY
	([PurchaseOrder_Id]) REFERENCES [Services.Packages.Purchase] ([Id]);
GO


ALTER TABLE [dbo].[SePaPuLi] ADD CONSTRAINT [FK.MoUs:Ow:PuLi] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaSeMoUs] ADD CONSTRAINT [FK.MoUs:Ow:MoUs] FOREIGN KEY
	([Owner_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaSeMoSe] ADD CONSTRAINT [FK.MoUs:Us:MoSe] FOREIGN KEY
	([User_Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


/** Services.Packages.Security.ModelUserRights Relations **/

ALTER TABLE [dbo].[SePaSeMoUsRi] ADD CONSTRAINT [FK.MoUs:Us:MoUsRi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO
...
ALTER TABLE [dbo].[SePaSeIPSeRe] ADD CONSTRAINT [FK.IPRe:IP:IPSeRe] FOREIGN KEY
	([IP_IP]) REFERENCES [Services.Packages.Security.IPRegistered] ([IP]);
GO


ALTER TABLE [dbo].[SePaSeIPSeRe] ADD CONSTRAINT [FK.MoSe:Se:IPSeRe] FOREIGN KEY
	([Session_SessionToken]) REFERENCES [Services.Packages.Security.ModelSession] ([SessionToken]);
GO


/** Services.Packages.Security.PackageAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSePaAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:PaAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSePaAcCoLi] ADD CONSTRAINT [FK.Pa:Pa:PaAcCoLi] FOREIGN KEY
	([Id]) REFERENCES [Services.Packages.Package] ([Id]);
GO


/** Services.Packages.Security.PackageAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSePaAcCoEn] ADD CONSTRAINT [FK.PaAcCoLi:ACL:PaAcCoEn] FOREIGN KEY
	([UserName], [Id]) REFERENCES [Services.Packages.Security.PackageAccessControlList] ([UserName], [Id]);
GO


/** Services.Packages.Security.ApiKeyAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSeApKeAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:ApKeAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSeApKeAcCoLi] ADD CONSTRAINT [FK.ApKe:ApKe:ApKeAcCoLi] FOREIGN KEY
	([Id]) REFERENCES [Services.Packages.ApiKey] ([Id]);
GO


/** Services.Packages.Security.ApiKeyAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSeApKeAcCoEn] ADD CONSTRAINT [FK.ApKeAcCoLi:ACL:ApKeAcCoEn] FOREIGN KEY
	([UserName], [Id]) REFERENCES [Services.Packages.Security.ApiKeyAccessControlList] ([UserName], [Id]);
GO


/** Services.Packages.Log.Security.ApplicationExceptionAccessControlList Relations **/

ALTER TABLE [dbo].[SePaLoSeApExAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:ApExAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaLoSeApExAcCoLi] ADD CONSTRAINT [FK.ApEx:ApEx:ApExAcCoLi] FOREIGN KEY
	([Id]) REFERENCES [Services.Packages.Log.ApplicationException] ([Id]);
GO


/** Services.Packages.Log.Security.ApplicationExceptionAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaLoSeApExAcCoEn] ADD CONSTRAINT [FK.ApExAcCoLi:ACL:ApExAcCoEn] FOREIGN KEY
	([UserName], [Id]) REFERENCES [Services.Packages.Log.Security.ApplicationExceptionAccessControlList] ([UserName], [Id]);
GO


/** Services.Packages.Security.CustomerAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSeCuAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:CuAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSeCuAcCoLi] ADD CONSTRAINT [FK.Cu:Cu:CuAcCoLi] FOREIGN KEY
	([Name]) REFERENCES [Services.Packages.Customer] ([Name]);
GO


/** Services.Packages.Security.CustomerAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSeCuAcCoEn] ADD CONSTRAINT [FK.CuAcCoLi:ACL:CuAcCoEn] FOREIGN KEY
	([UserName], [Name]) REFERENCES [Services.Packages.Security.CustomerAccessControlList] ([UserName], [Name]);
GO


/** Services.Packages.Security.CustomerUserEntryAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSeCuUsEnAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:CuUsEnAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSeCuUsEnAcCoLi] ADD CONSTRAINT [FK.CuUsEn:CuUsEn:CuUsEnAcCoLi] FOREIGN KEY
	([Id]) REFERENCES [Services.Packages.CustomerUserEntry] ([Id]);
GO


/** Services.Packages.Security.CustomerUserEntryAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSeCuUsEnAcCoEn] ADD CONSTRAINT [FK.CuUsEnAcCoLi:ACL:CuUsEnAcCoEn] FOREIGN KEY
	([UserName], [Id]) REFERENCES [Services.Packages.Security.CustomerUserEntryAccessControlList] ([UserName], [Id]);
GO


/** Services.Packages.Security.PurchaseAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSePuAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:PuAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSePuAcCoLi] ADD CONSTRAINT [FK.Pu:Pu:PuAcCoLi] FOREIGN KEY
	([Id]) REFERENCES [Services.Packages.Purchase] ([Id]);
GO


/** Services.Packages.Security.PurchaseAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSePuAcCoEn] ADD CONSTRAINT [FK.PuAcCoLi:ACL:PuAcCoEn] FOREIGN KEY
	([UserName], [Id]) REFERENCES [Services.Packages.Security.PurchaseAccessControlList] ([UserName], [Id]);
GO


/** Services.Packages.Security.PurchaseLineAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSePuLiAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:PuLiAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSePuLiAcCoLi] ADD CONSTRAINT [FK.PuLi:PuLi:PuLiAcCoLi] FOREIGN KEY
	([Id]) REFERENCES [Services.Packages.PurchaseLine] ([Id]);
GO


/** Services.Packages.Security.PurchaseLineAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSePuLiAcCoEn] ADD CONSTRAINT [FK.PuLiAcCoLi:ACL:PuLiAcCoEn] FOREIGN KEY
	([UserName], [Id]) REFERENCES [Services.Packages.Security.PurchaseLineAccessControlList] ([UserName], [Id]);
GO


/** Services.Packages.Security.Security.ModelUserAccessControlList Relations **/

ALTER TABLE [dbo].[SePaSeSeMoUsAcCoLi] ADD CONSTRAINT [FK.MoUs:Us:MoUsAcCoLi] FOREIGN KEY
	([UserName]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


ALTER TABLE [dbo].[SePaSeSeMoUsAcCoLi] ADD CONSTRAINT [FK.MoUs:MoUs:MoUsAcCoLi] FOREIGN KEY
	([Name]) REFERENCES [Services.Packages.Security.ModelUser] ([Name]);
GO


/** Services.Packages.Security.Security.ModelUserAccessControlEntry Relations **/

ALTER TABLE [dbo].[SePaSeSeMoUsAcCoEn] ADD CONSTRAINT [FK.MoUsAcCoLi:ACL:MoUsAcCoEn] FOREIGN KEY
	([UserName], [Name]) REFERENCES [Services.Packages.Security.Security.ModelUserAccessControlList] ([UserName], [Name]);
GO
